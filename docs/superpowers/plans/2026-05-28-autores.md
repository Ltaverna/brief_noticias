...
- Cobertura del spec: todas las secciones del spec tienen al menos una tarea (decisión 1 → Task 7; 2 → Tasks 5+6; 3 → Tasks 3+4; 4 M1 → 11; M2 → 12; M3 → 14; M4 → 15; similares → 13; 5 UI → 18-22; 6 umbral n=3 → 12, 14, 20).
